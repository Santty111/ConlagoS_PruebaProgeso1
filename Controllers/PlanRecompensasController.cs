...
namespace ConlagoS_PruebaProgeso1.Controllers
{
    public class PlanRecompensasController : Controller
    {
        ...
        public PlanRecompensasController(ConlagoS_PruebaProgeso1Context context)
        {
            _context = context;
        }
        ...
        {
            var conlagoS_PruebaProgeso1Context = _context.PlanRecompensa.Include(p => p.Cliente);
            return View(await conlagoS_PruebaProgeso1Context.ToListAsync());
        }
